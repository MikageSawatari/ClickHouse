...
-- Test 256-bit support (253 bits = 11 x 23)
SELECT length(encodeBit11String(63, 9223372036854775807, 63, 9223372036854775807, 63, 9223372036854775807, 64, 18446744073709551615)) = 46; -- 23 * 2 characters
SELECT encodeBit11String(63, 9223372036854775807, 63, 9223372036854775807, 63, 9223372036854775807, 64, 18446744073709551615) = '7b7b7b7b7b7b7b7b7b7b7b7b7b7b7b7b7b7b7b7b7b7b7b';
SELECT decodeBit11String(encodeBit11String(63, 9223372036854775807, 63, 9223372036854775807, 63, 9223372036854775807, 64, 18446744073709551615), 63, 63, 63, 64) = [9223372036854775807, 9223372036854775807, 9223372036854775807, 18446744073709551615];